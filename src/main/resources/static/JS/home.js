...
let managerCalender;
    ...
    function loadCalendar(userRole) {
        if (userRole !== "ROLE_MANAGER") {
            if(userRole === "ROLE_STAFF" ) {
                ...
                btnMeeting.onclick = function(){openClientMeetingForm()};
                ...
                btnList.onclick = function(){openListOfClientsForm()};
    ...
    // setting up manager functions
            ...
            btnApp.onclick = function(){openCreateAppointmentForm()};
            ...
            btnHouse.onclick = function(){openCreateHouseForm()};
            ...
            btnCreateClient.onclick = function(){openCreateClientForm()};
            ...
            btnCreateStaff.onclick = function(){openCreateStaffForm()};
            ...
            btnRemoveHouse.onclick = function(){openRemoveHouseForm()};
            ...
            btnUpdateHouse.onclick = function(){openUpdateSupportHouse()};
            ...
            btnChangeHouse.onclick = function(){openChangeHouseForm()};
            ...
            btnRemoveStaffApp.onclick = function(){openRemoveStaffApp()};
            ...
            btnRemoveClientApp.onclick = function(){openRemoveClientApp()};
            ...
            btnRemoveStaff.onclick = function(){openRemoveStaffMember()};
            ...
            btnRemoveClient.onclick = function(){openRemoveClient()};
            ...
            btnRemoveManager.onclick = function(){openRemoveStaffManager()};
            ...
            btnClientDetails.onclick = function(){openDisplayClientsDetails()};
            ...
            btnStaffDetails.onclick = function(){openDisplayStaffsDetails()};
            ...
            btnDisplayClientsApp.onclick = function(){openDisplayClientsApp()};
            ...
            btnDisplayStaffApp.onclick = function(){openDisplayStaffsApp()};
            ...
            btnDisplayClientsNotes.onclick = function(){openDisplayClientsNotes()};
